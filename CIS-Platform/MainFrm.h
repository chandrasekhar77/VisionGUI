...
#define ID_DASHTOOLBAR         2005
#define ID_PANE_IMAGE          2006
#define ID_PANE_PANELLIST      2007
#define ID_PANE_DEFECTSUMMARY  2008
#define ID_PANE_STATS          2009
#define ID_PANE_YIELD          2010
...
protected:
	...
	CDashboardToolbar    m_wndDashToolbar;
	CInspectionImagePane m_wndImagePane;
	CPanelListPane       m_wndPanelListPane;
	CDefectSummaryPane   m_wndDefectSummaryPane;
	CStatsPane           m_wndStatsPane;
	CYieldChartPane      m_wndYieldChartPane;

	int m_navIndex = 0;
	int m_dashboardSubTab = Theme::SUBTAB_MAIN;
